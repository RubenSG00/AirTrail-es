  ...
  <div class="space-y-4">
    <div class="space-y-2">
      ...
      <p class="text-muted-foreground text-sm">
        <a
          href="https://github.com/RubenSG00/AirTrail-es/releases/tag/v{version}"
          target="_blank"
    ...
    <div class="space-y-2">
      ...
      <p class="text-muted-foreground text-sm">
        ...
        {:else if versionState.latestVersion}
          <a
            href="https://github.com/RubenSG00/AirTrail-es/releases/tag/v{versionState.latestVersion}"
            target="_blank"
            rel="noopener noreferrer"
            class="font-mono font-semibold text-primary hover:underline"
          >
