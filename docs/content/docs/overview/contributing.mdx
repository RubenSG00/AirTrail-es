...
If you encounter a bug, please open an issue on the [GitHub repository](https://github.com/RubenSG00/AirTrail-es/issues).
...
a [new discussion](https://github.com/RubenSG00/AirTrail-es/discussions/new).
